$(document).ready(function(){
    ...
    let url = "https://newsapi.org/v2/everything?q=apple&from=2020-01-02&to=2020-01-02&sortBy=popularity&apiKey=1f363ff4d9034d328711bc79634a7fc5";
              ...
              output += `
                ...
                <div class="card medium hoverable">
                  ...
                  <div class="card-content">
                    ...
                    <p><b>Moniker</b>: ${latestNews[i].author} </p>
                    <p><b>Section</b>: ${latestNews[i].source.name} </p>
                    <p><b>Date</b>: ${latestNews[i].publishedAt} </p>
                  </div>
